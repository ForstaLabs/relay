...
public class DeliveryReceiptJobTest extends BaseUnitTest {
  ...
  public static class TestModule {
    ...
    @Provides
    TextSecureCommunicationModule.TextSecureMessageSenderFactory provideSignalServiceMessageSenderFactory() {
      return new TextSecureCommunicationModule.TextSecureMessageSenderFactory() {
        @Override

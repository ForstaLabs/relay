...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.forsta.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("org.forsta.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }

...
import org.forsta.securesms.attachments.DatabaseAttachment;
...
import org.forsta.securesms.database.documents.IdentityKeyMismatchList;
import org.forsta.securesms.database.documents.NetworkFailure;
import org.forsta.securesms.database.documents.NetworkFailureList;
import org.forsta.securesms.database.model.DisplayRecord;
import org.forsta.securesms.database.model.MediaMmsMessageRecord;
import org.forsta.securesms.database.model.MessageRecord;
import org.forsta.securesms.database.model.NotificationMmsMessageRecord;
import org.forsta.securesms.jobs.TrimThreadJob;
import org.forsta.securesms.mms.IncomingMediaMessage;
...
import org.forsta.securesms.util.JsonUtils;
import org.forsta.securesms.util.ServiceUtil;
...
import static org.forsta.securesms.util.Util.canonicalizeNumber;
import static org.forsta.securesms.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.forsta.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.forsta.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.forsta.securesms.util.Util.toIsoBytes(transactionId);

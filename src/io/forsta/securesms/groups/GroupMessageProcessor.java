...
import io.forsta.securesms.jobs.AvatarDownloadJob;
import io.forsta.securesms.mms.OutgoingGroupMediaMessage;
import io.forsta.securesms.notifications.MessageNotifier;
import io.forsta.securesms.recipients.RecipientFactory;
import io.forsta.securesms.recipients.Recipients;
import io.forsta.securesms.sms.IncomingGroupMessage;
                                             ...
                                             boolean  outgoing)
  {
    ...
    try {
      if (outgoing) {
        ...
        OutgoingGroupMediaMessage outgoingMessage = new OutgoingGroupMediaMessage(recipients, storage, null, envelope.getTimestamp(), 0,null);

...
public abstract class MediaConstraints {
      ...
      throws IOException
  {
    ...
    try {
      ...
      return new MediaStream(new ByteArrayInputStream(BitmapUtil.createScaledBytes(context, new DecryptableStreamUriLoader.DecryptableUri(masterSecret, attachment.getDataUri()), this)),

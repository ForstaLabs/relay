...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://io.forsta.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("io.forsta.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }

...
public class TextSecurePreferences {
  ...
  public static Set<String> getNotificationPreferences(Context context) {
    return PreferenceManager.getDefaultSharedPreferences(context).getStringSet(NOTIFICATION_FILTER, new HashSet<String>(Arrays.asList(context.getResources().getStringArray(R.array.pref_notification_filter_values))));
  }

        ...
        InputPanel.Listener
{
  ...
  private void handleInviteLink() {
    try {
      ...
      if (a) composeText.appendInvite(getString(R.string.ConversationActivity_lets_switch_to_signal, "https://tinyurl.com/gsfpkql"));
      else   composeText.appendInvite(getString(R.string.ConversationActivity_lets_use_this_to_chat, "https://tinyurl.com/gsfpkql"));

...
import io.forsta.securesms.database.SmsMigrator;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "io.forsta.securesms.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "io.forsta.securesms.ApplicationMigrationService.COMPLETED";
